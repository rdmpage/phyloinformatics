...
function init(){
	...
	// Root of tree with the 8 major groups recognised by CoL
	var json = "{id:0,name:\"root\",data:\"\",children:[{id:\"2334808\",name:\"Animalia\",data:\"\",children:[]},{id:\"2340192\",name:\"Archaea\",data:\"\",children:[]},{id:\"2334975\",name:\"Bacteria\",data:\"\",children:[]},{id:\"2337576\",name:\"Chromista\",data:\"\",children:[]},{id:\"2338201\",name:\"Fungi\",data:\"\",children:[]},{id:\"2334970\",name:\"Plantae\",data:\"\",children:[]},{id:\"2336186\",name:\"Protozoa\",data:\"\",children:[]},{id:\"2337822\",name:\"Viruses\",data:\"\",children:[]}]}";
    //end
    ...
    var st = new $jit.ST({
        ...
        request: function(nodeId, level, onComplete) {
          ...
          // Load subtree rooted on this node from external classification
            $.getJSON('tree.php?node=' + nodeId + "&callback=?",
			function(data){
